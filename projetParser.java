// $ANTLR 3.5.2 projet.g 2020-02-20 10:01:29
...
public class projetParser extends Parser {
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			match(input,11,FOLLOW_11_in_lecture857); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture870); 
			match(input,10,FOLLOW_10_in_ecriture872); 
				...
				case 2 :
					...
					switch (alt35) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel935);
							effixes();
							state._fsp--;
							...
							switch (alt34) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel938);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effixes970); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effixes977); 
			...
			match(input,11,FOLLOW_11_in_effixes987); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effmods999); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effmods1006); 
			...
			match(input,11,FOLLOW_11_in_effmods1016); 
			}
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,47,FOLLOW_47_in_expression1034); 
					PtGen.pt(281);
					pushFollow(FOLLOW_exp1_in_expression1038);
					exp1();
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_exp11062); 
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_exp21083); 
					pushFollow(FOLLOW_exp2_in_exp21085);
					exp2();
					state._fsp--;
				...
				case 2 :
					// projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21092);
					exp3();
					state._fsp--;
		...
		try {
			...
			switch (alt44) {
				...
				case 2 :
					// projet.g:158:5: '<>' exp4
					{
					match(input,21,FOLLOW_21_in_exp31126); 
				...
				case 6 :
					// projet.g:162:5: '<=' exp4
					{
					match(input,20,FOLLOW_20_in_exp31168); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_exp41205); 
				...
				case 2 :
					...
					{
					match(input,15,FOLLOW_15_in_exp41220); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp51265); 
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_exp51284); 
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1311);
					valeur();
					state._fsp--;
	...
	public static final BitSet FOLLOW_11_in_lecture857 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture870 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture872 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture874 = new BitSet(new long[]{0x0000000000004800L});
	...
	public static final BitSet FOLLOW_effixes_in_affouappel935 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_effmods_in_affouappel938 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effixes970 = new BitSet(new long[]{0x008040400000AC60L});
	public static final BitSet FOLLOW_expression_in_effixes973 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effixes977 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_effixes979 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effixes987 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effmods999 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_ident_in_effmods1002 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effmods1006 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods1008 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effmods1016 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp1_in_expression1030 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_47_in_expression1034 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp1_in_expression1038 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_exp2_in_exp11059 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_35_in_exp11062 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp11065 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_46_in_exp21083 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp21085 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp3_in_exp21092 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31108 = new BitSet(new long[]{0x0000000001F80002L});
	public static final BitSet FOLLOW_22_in_exp31115 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31119 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_exp31126 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31129 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_20_in_exp31168 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_13_in_exp41205 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41208 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_15_in_exp41220 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_12_in_exp51265 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51269 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_32_in_exp51284 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51287 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1311 = new BitSet(new long[]{0x0000000000000002L});
