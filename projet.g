...
unite  :   unitprog {PtGen.pt(400);} { System.out.println("succes, arret de la compilation "); } EOF
      |    unitmodule {PtGen.pt(400);} { System.out.println("succes, arret de la compilation "); } EOF
  ;
